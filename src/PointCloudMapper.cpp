...
namespace ORB_SLAM3
{
    ...
    PointCloudMapper::PointCloudMapper()
    {
        ...
        // mpVoxel->setLeafSize(0.01, 0.01, 0.01); // 体素叶子太小，容易出现：[pcl::VoxelGrid::applyFilter] Leaf size is too small for the input dataset. Integer indices would overflow. 的错误！
    ...
    void PointCloudMapper::run()
    {
        ...
        cout << endl
             << "PointCloudMapping thread start!" << endl;
        int ID = 0;
        while (1)
        {
            {
